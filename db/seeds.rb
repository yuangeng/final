...
Availability.create("dish_id" => kome.id, "store_id" => rmch1.id)
Availability.create("dish_id" => kome.id, "store_id" => rmch2.id)
Availability.create("dish_id" => mame.id, "store_id" => rmch1.id)
Availability.create("dish _id" => mame.id, "store_id" => rmch2.id)
Availability.create("dish_id" => shiro.id, "store_id" => rmch1.id)
Availability.create("dish_id" => shiro.id, "store_id" => rmch2.id)
Availability.create("dish_id" => shiromaru.id, "store_id" => ipny1.id)
Availability.create("dish_id" => shiromaru.id, "store_id" => ipny2.id)
Availability.create("dish_id" => akamaru.id, "store_id" => ipny1.id)
Availability.create("dish_id" => akamaru.id, "store_id" => ipny2.id)
Availability.create("dish_id" => karaka.id, "store_id" => ipny1.id)
Availability.create("dish_id" => karaka.id, "store_id" => ipny2.id)
Availability.create("dish_id" => tonkotsu2.id, "store_id" => mrny1.id)
Availability.create("dish_id" => spicymiso.id, "store_id" => mrny1.id)
Availability.create("dish_id" => tokyoshio.id, "store_id" => irny2.id)
Availability.create("dish_id" => tokyoshio.id, "store_id" => irny1.id)
Availability.create("dish_id" => shoyu.id, "store_id" => irny2.id)
Availability.create("dish_id" => shoyu.id, "store_id" => irny1.id)
Availability.create("dish_id" => tonkotsu.id, "store_id" => wach1.id)
Availability.create("dish_id" => spicygarlic.id, "store_id" => wach1.id)
